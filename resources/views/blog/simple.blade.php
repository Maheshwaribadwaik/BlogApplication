            ...
            <form action="{{ Route('update', $form->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="profile_image" placeholder="Upload profile Image" name="profile_image"
                        value={{ old('profile_image') }} >
                    <div class="form-group">
                        <label>Status</label>
                        <select name="status"class="form-control">
                            <option value="" class="option_colour">Select Status</option>
                            <option value="1" @if ($form->status == '1') selected='selected' @endif>
                                Active
                            </option>
                            <option value="0" @if ($form->status == '0') selected='selected' @endif>
                                Inactive
                            </option>
